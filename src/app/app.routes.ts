...
import { authGuardFn, loginGuardFn } from './guards/auth.guard';

export const routes: Routes = [
    {path: '', redirectTo: 'products', pathMatch: 'full'},
    {path: '', component: NavlayoutComponent, canActivateChild: [authGuardFn], children: [
    ...
    {path: 'login', canActivate: [loginGuardFn], component: LoginComponent},
